...
def decode_access_token(token):
 p=jwt.decode(token,settings.jwt_secret,algorithms=[settings.jwt_algorithm],audience="primevpn-web",issuer="primevpn-control",options={"require":["exp","iat","sub","type","jti"]})
