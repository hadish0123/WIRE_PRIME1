...
def create_payment(order_id:str,provider:str,provider_reference:str,admin:Admin=Depends(current_admin),db:Session=Depends(get_db)):
...
def confirm_payment(payment_id:str,admin:Admin=Depends(current_admin),db:Session=Depends(get_db)):
...
def subscribe(client_id:str,plan_id:str,admin:Admin=Depends(current_admin),db:Session=Depends(get_db)):
