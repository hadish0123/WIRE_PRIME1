...
from .routers import auth,tenants,nodes,inbounds,clients,traffic,audit,quotas,admins,provisioning,configs,credentials,commerce,settings
for router,prefix,tags in [(auth.router,"/api/v1/auth",["auth"]),(tenants.router,"/api/v1/tenants",["tenants"]),(nodes.router,"/api/v1/nodes",["nodes"]),(inbounds.router,"/api/v1/inbounds",["inbounds"]),(clients.router,"/api/v1/clients",["clients"]),(traffic.router,"/api/v1/traffic",["traffic"]),(audit.router,"/api/v1/audit",["audit"]),(quotas.router,"/api/v1/quotas",["quotas"]),(admins.router,"/api/v1/admins",["admins"]),(provisioning.router,"/api/v1/provisioning",["provisioning"]),(configs.router,"/api/v1/configs",["configs"]),(credentials.router,"/api/v1/credentials",["credentials"]),(commerce.router,"/api/v1/commerce",["commerce"]),(settings.router,"/api/v1/settings",["settings"])]:app.include_router(router,prefix=prefix,tags=tags)
